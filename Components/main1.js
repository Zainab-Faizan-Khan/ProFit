...
export default function Main({ navigation }) {
  ...
  function getexcersises() {
    ...
    var e = [];
    try {
      firebase.db.collectionGroup("myexer").onSnapshot((snapshot) => {
        snapshot.forEach((doc) => {
          if (doc) {
            ...
            setmsg("You dont have any excersises at the moment");
          }
        });
            ...
            <ScrollView horizontal={true}>
              {erx.map((item) => (
                ...
                >
                  <TouchableOpacity
                    onPress={() => {
                      ExcersiseStore.setimg(item[1]);
                      ExcersiseStore.settitle(item[0]);
                      begin();
                    }}
                  >
                    <Image
          ...
          >
            <View style={{ justifyContent: "center", alignItems: "center" }}>
              <TouchableOpacity
                ...
                onPress={() => {
                  User.setchoice("Arms");
                  navigation.navigate("EA");
                }}
              >
                <Image
                  style={{ height: 70, width: 70 }}
                  source={{
                    uri: "https://tse2.mm.bing.net/th?id=OIP.AKljJEmMUJOgX5hlUU8OKAHaEG&pid=Api&P=0&w=321&h=177",
                  }}
                  resizeMode="stretch"
                ></Image>
              </TouchableOpacity>
            ...
            <View style={{ justifyContent: "center", alignItems: "center" }}>
              ...
              >
                <Image
                  style={{ height: 70, width: 70 }}
                  source={{
                    uri: "https://tse3.mm.bing.net/th?id=OIP.avNDsChtXFxlwuAd3HoBDQHaFj&pid=Api&P=0&w=223&h=167",
                  }}
                  resizeMode="stretch"
                ></Image>
              </TouchableOpacity>
            ...
            <View style={{ justifyContent: "center", alignItems: "center" }}>
              ...
              >
                <Image
                  style={{ height: 70, width: 70 }}
                  source={{
                    uri: "https://tse3.mm.bing.net/th?id=OIP.SXnJ5uZ20hhbOfpogg_ADgHaE8&pid=Api&P=0&w=231&h=154",
                  }}
                  resizeMode="stretch"
                ></Image>
              </TouchableOpacity>
            ...
            <View style={{ justifyContent: "center", alignItems: "center" }}>
              ...
              >
                <Image
                  style={{ height: 70, width: 70 }}
                  source={{
                    uri: "https://tse3.mm.bing.net/th?id=OIP.0gUwMZ8dPpJ_j0_LF5ygDwHaE8&pid=Api&P=0&w=282&h=188",
                  }}
                  resizeMode="stretch"
                ></Image>
              </TouchableOpacity>
